...
public class OauthUserDetails implements UserDetails {
    ...
    protected com.wenyu.oauth.model.User user;
    ...
    public OauthUserDetails(com.wenyu.oauth.model.User user) {
        this.user = user;
    }
    ...
    public com.wenyu.oauth.model.User user() {
        return user;
    }
    ...
    public com.wenyu.oauth.model.User getUser() {
        return user;
    }
