...
public class StringUtils {
    ...
    /**
     * Returns Date like pattern
     * UnsupportedEncodingException (in lieu of log message)
     *
     * @param date    Date
     * @param pattern for SimpleDateFormat("*") you can write pattern like "yyyy" or "yyyyMM" and orthers
     * @return The UTF-8 encoded String for the given byte array
     */
    public static String Date2String(Date date, String pattern) {
        ...
        try {
            ...
            Log.warn("date fromat error exception:" + e.getMessage());
