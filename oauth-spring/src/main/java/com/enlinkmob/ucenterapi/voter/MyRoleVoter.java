...
package com.enlinkmob.ucenterapi.voter;
...
public class MyRoleVoter implements AccessDecisionVoter<Object> {
    ...
    public int vote(Authentication authentication, Object object,
        ...
        //加入role权限控制
        User user = UserThreadLocal.getContext().getCurrentUser();
        user = this.userAuthoritiesService.getUserWithAuthorities(user.getId(), AuthorityType.ROLE);
